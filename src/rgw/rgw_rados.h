...
class RGWRados
{
  ...
  int get_obj_state_impl(RGWObjectCtx *rctx, const RGWBucketInfo& bucket_info, const rgw_obj& obj, RGWObjState **state, bool follow_olh);
...
public:
  ...
  public:
    ...
    public:
      ...
      UpdateIndex(RGWRados::Bucket *_target, const rgw_obj& _obj, RGWObjState *_state) : target(_target), obj(_obj), obj_state(_state), bilog_flags(0),
  ...
  int get_obj_state(RGWObjectCtx *rctx, const RGWBucketInfo& bucket_info, const rgw_obj& obj, RGWObjState **state, bool follow_olh);
...
public:
  ...
  virtual int throttle_data(void *handle, const rgw_raw_obj& obj, bool need_to_wait) = 0;
}; /* RGWPutObjDataProcessor */
...
public:
  int throttle_data(void *handle, const rgw_raw_obj& obj, bool need_to_wait);
