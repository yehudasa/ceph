...
public:
  ...
  int remove(RGWBucketAdminOpState& op_state, bool bypass_gc = false, std::string *err_msg = NULL);
...
public:
  ...
  static int remove_bucket(RGWRados *store, RGWBucketAdminOpState& op_state, bool bypass_gc = false);
