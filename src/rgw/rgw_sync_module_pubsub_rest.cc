...
public:
  ...
  const string name() override { return "pubsub_topic_create"; }
...
public:
  ...
  const string name() override { return "pubsub_topics_list"; }
...
public:
  ...
  const string name() override { return "pubsub_topic_get"; }
...
public:
  ...
  const string name() override { return "pubsub_topic_delete"; }
...
public:
  ...
  const string name() override { return "pubsub_subscription_create"; }
...
public:
  ...
  const string name() override { return "pubsub_subscription_get"; }
...
public:
  ...
  const string name() override { return "pubsub_subscription_delete"; }
...
public:
  ...
  const string name() override { return "pubsub_subscription_ack"; }
...
public:
  ...
  const string name() override { return "pubsub_subscription_pull"; }
...
public:
  ...
  const string name() override { return "pubsub_notification_create"; }
...
public:
  ...
  const string name() override { return "pubsub_notification_delete"; }
...
public:
  ...
  const string name() override { return "pubsub_notifications_list"; }
