                                    ...
                                    rgw_user& user)
{
  ...
  ceph::real_clock::to_ceph_timespec(state->mtime, ts);
  snprintf(buf, sizeof(buf), "%03d%s%lld.%06lld", (int)src_name.size(), src_name.c_str(),
