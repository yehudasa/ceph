...
dout(0) << __FILE__ << ":" << __LINE__ << ":" << __func__ << "(): cache=" << (void *)this << " statement=" << stmt << dendl;
      return stmt;
    }
    auto stmt = l.front();
dout(0) << __FILE__ << ":" << __LINE__ << ":" << __func__ << "(): cache=" << (void *)this << " statement=" << stmt << dendl;
...
dout(0) << __FILE__ << ":" << __LINE__ << ":" << __func__ << "(): cache=" << (void *)stmt_cache.get() << " statement=" << statement << dendl;
