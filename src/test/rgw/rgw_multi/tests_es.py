...
def init_es_test(create_obj, num_keys = 5, buckets_per_zone = 1, bucket_init_cb = None):
    check_es_configured()
...
def test_es_object_search():
    ...
    targets, _, buckets, src_keys = init_es_test(create_obj, num_keys = 5, buckets_per_zone = 2)
...
def test_es_object_search_custom():
    ...
    targets, _, buckets, src_keys = init_es_test(create_obj, num_keys = 5, buckets_per_zone = 1, bucket_init_cb = bucket_init)
...
def test_es_bucket_conf():
    ...
    targets, sources, buckets, _ = init_es_test(None, num_keys = 5, buckets_per_zone = 1, bucket_init_cb = bucket_init)
