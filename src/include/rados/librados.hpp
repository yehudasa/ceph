...
namespace librados
{
  ...
  public:
    ...
    void stat2(uint64_t *psize, ceph::real_time *pmtime, int *prval);
  ...
  public:
    ...
    int stat2(const std::string& oid, uint64_t *psize, ceph::real_time *pmtime);
    ...
    int aio_stat2(const std::string& oid, AioCompletion *c, uint64_t *psize, ceph::real_time *pmtime);
